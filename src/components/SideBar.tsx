...
export const SideBar = () => {
  ...
  return (
    ...
    >
      <div className="p-3 bg-emerald-600 gap-5  flex items-center justify-start">
        <Button
          onClick={() => setOpen((prev) => !prev)}
          className=" rounded-md border-yellow-500 p-0 w-[50px] h-[50px]  border-[1px]  bg-transparent"
          type="button"
          variant={"outline"}
        >
